...
version `202606300117`, from Scenario A through Scenario V.
...
| `V-2` | V | A revoked Farmer accreditation prevents acceptance of product-origin data. | Skipped: pending implementation |
