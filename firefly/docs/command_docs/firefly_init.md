...
```
firefly init [stack_name] [member_count] [flags]
```
...
```
  ...
  -c, --blockchain-connector string          Blockchain connector to use. Options are: [ethconnect evmconnect tezosconnect fabric] (default "evmconnect")
  -n, --blockchain-node string               Blockchain node type to use. Options are: [geth quorum besu remote-rpc] (default "geth")
  -b, --blockchain-provider string           Blockchain to use. Options are: [ethereum tezos fabric corda] (default "ethereum")
      --chain-id int                         The chain ID (Ethereum only) - also used as the network ID (default 2021)
...
* [firefly init ethereum](firefly_init_ethereum.md)	 - Create a new FireFly local dev stack using an Ethereum blockchain
* [firefly init fabric](firefly_init_fabric.md)	 - Create a new FireFly local dev stack using a Fabric network
* [firefly init tezos](firefly_init_tezos.md)	 - Create a new FireFly local dev stack using an Tezos blockchain
